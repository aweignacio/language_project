...
| 4 | 部署平台 | **GCP**（Cloud Run + Cloud SQL + Cloud Storage） | 帳號 2026-08-15 啟用，$300 額度至 2026-11-13 左右到期，前三個月零成本；且具履歷價值 |
...
| **$300 額度到期日** | 帳號 2026-08-15 啟用，推估 2026-11-13 前後到期。需於 Billing 頁面確認確切日期 | 階段 0 |
